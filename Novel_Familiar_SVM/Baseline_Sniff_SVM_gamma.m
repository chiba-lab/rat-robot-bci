...
FID = fopen('Classification_Accuracy_Sniffing_Baseline_Gamma.txt', 'w');
...
for z = 1:5
            MJ_Ref =  sniffing_train_gamma;      
            MJ_Comp = baseline_train_gamma;
            ...
            fprintf(FID, 'Baseline1\t Sniffing1\t %s\t %6.4f *** \t\n', num2str(z), twoway_accuracy_MJ_L1_L2)
            else
            fprintf(FID, 'Baseline1\t Sniffing1\t %s\t %6.4f\t\n', num2str(z), twoway_accuracy_MJ_L1_L2)
            end
end
