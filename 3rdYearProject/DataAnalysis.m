...
%% Both
Groom = [Groom_Rat1; Groom_Rat2];
Baseline = [Baseline_Rat1; Baseline_Rat2];
RatSniff = [RatSniff_Rat1; RatSniff_Rat2];
%Measure size of all
G_size = size(Groom_Rat1, 1) + size(Groom_Rat2, 1);
B_size = size(Baseline_Rat1, 1) + size(Baseline_Rat2, 1);
RS_size = size(RatSniff_Rat1, 1) + size(RatSniff_Rat2, 1);
...
xlim([0 100])
ylim(myYlims)
title('Olfactory Bulb PSD For Behaviors Of Interest')
