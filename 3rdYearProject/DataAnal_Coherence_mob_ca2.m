...
%% Rat 1
Groom = [Groom_Rat1]; % Groom_Rat1_amyg
Baseline = [Baseline_Rat1];
RatSniff = [RatSniff_Rat1];
%Measure size of all
G_size = size(Groom_Rat1, 1);
B_size = size(Baseline_Rat1, 1);
RS_size = size(RatSniff_Rat1, 1);
...
% %% Both
% Groom = [Groom_Rat1; Groom_Rat2_amyg];
% Baseline = [Baseline_Rat1; Baseline_Rat2_amyg];
% RatSniff = [RatSniff_Rat1; RatSniff_Rat2_amyg];
% %Measure size of all
% G_size = size(Groom_Rat1, 1) + size(Groom_Rat2_amyg, 1);
% B_size = size(Baseline_Rat1, 1) + size(Baseline_Rat2_amyg, 1);
% RS_size = size(RatSniff_Rat1, 1) + size(RatSniff_Rat2_amyg, 1);
% 
% for i = 1:RS_size
%     LFP = RatSniff(i,:);
%     [Pxx,F] = pwelch(LFP,w,overlap,NFFT,Fs);
